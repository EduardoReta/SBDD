...
CREATE TABLE tblDONACIONES(
	ID_DONACION SMALLINT NOT NULL PRIMARY KEY, 
...
CREATE TABLE tblDEVOLUCION(
	...
	ID_PRESTAMO SMALLINT FOREIGN KEY REFERENCES tblPRESTAMOS(ID_PRESTAMO),
	ID_USUARIO INT FOREIGN KEY REFERENCES tblUSUARIO(ID_USUARIO),
